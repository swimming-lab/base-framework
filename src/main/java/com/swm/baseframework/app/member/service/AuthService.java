...
import com.swm.baseframework.app.member.domain.RefreshToken;
...
import com.swm.baseframework.app.member.repository.RefreshTokenRepository;
...
public class AuthService {
    ...
    public TokenDto reissue(RefreshTokenDto refreshTokenDto) {
        ...
        Authentication authentication = tokenProvider.getAuthentication(refreshTokenDto.getAccessToken());
        ...
        if (!refreshToken.getValue().equals(refreshTokenDto.getRefreshToken())) {
